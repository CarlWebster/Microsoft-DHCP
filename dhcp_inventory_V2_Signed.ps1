...
[string]$Script:RunningOS = (Get-CIMInstance -class Win32_OperatingSystem -EA 0).Caption
...
Function ProcessServerProperties
{
	...
	If($Script:DHCPServerName -eq $env:computername)
	{
		$osInfo = Get-CIMInstance -Class Win32_OperatingSystem -Verbose:$False
	}
	Else
	{
		$osInfo = Get-CIMInstance -Class Win32_OperatingSystem -CIMSession $Script:DHCPServerName -Verbose:$False
	}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8D98b40QnaFfmYvAcVy0XlRN
# wVWggiEmMIIFkDCCA3igAwIBAgIQBZsbV56OITLiOQe9p3d1XDANBgkqhkiG9w0B
...
# AKBAMBkGCSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMCMGCSqGSIb3DQEJBDEWBBQt
# IohnCywhM9iMVyNAKKol48F49TANBgkqhkiG9w0BAQEFAASCAgCTVGUKAx1cdH0H
# Vwlp5jgOVPheihop5ab5lSmq7giv9o6ts2wHZx1Yjd4ndJGEh+sKSgOnUgQdtQMq
# 1rq46RzJDcjh1aIg3crrAWCW8QpvOhtknVoNtGnYcnWkG/q59fPOXU3WULGrM8s7
# Kflat6Xm8nuHiKu2QXKjPEVYgeL2fRNhew4RVX4HyOebLRY+QwgOAntmyf6fH1q8
# pSbRBaLyhm738z6pGRQhuEkT8jrIl8GbhUIdc9fCzqMiSQp6Eo91re6xehJFpcKs
# ZDO/n9gDwtxQfwWbh40eYaVVR2W7Q5qeQu0NauxLWpfHN14QeVfpyG9+W7a1lSYf
# oRyegG4lcNv6J3EOtagrCDWj9GjTitd1qp+ZGXJf8/WxS39aRoUWP1XZMYlO4J/a
# FuMGduwWLEnenCgY/2R4xeytLj4Erpygda/FyjY7cN3jC0F9T2BwmzArsvJ81rJy
# tMvNNjT8dp6yRkixYCjSRGzif8VpN5qDWmkt6usNFmDJYRez+1TAwnOoW4p37ABP
# IbUjAUnGVHM7e3lbnh6f38YfhY/GG6yCahlZRewhU8xvTehLo0s9FaJMBcGkRNII
# 2ixQUlbKdVC3zDCSksLBOS7NgDdRgBKzkfm+x0bLlgKhjcud3IkdqrzuJemPH2zD
# M0vJtWZV4ENM243t/xs+yWNWvag5JaGCAyAwggMcBgkqhkiG9w0BCQYxggMNMIID
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMjA0Mjgw
# NjQ2MjBaMC8GCSqGSIb3DQEJBDEiBCCmXBWf01PSdant5j5tLfqxBVoYhVJBPugL
# UA6kzPaCOjANBgkqhkiG9w0BAQEFAASCAgAVQeyzpmXb0sPr2ALLuD3GjxdKW4dg
# 3i0iZ15a4s3TCVoJLr7n60a04mtQRh+PEH9VTzPx6iWBGYevmx61Oyz/VOwgRU5f
# psLdVd3aw1TuVgsckLpIeBdikfBA5e4k4FUwfKVrOLzCOUoIxEcymu5/hycgxLX/
# N6vAEqlK3wqsDcjkePNI8FJIn3EBvpO2KCdNHRhePu9/e1eMebERaz6JNEjpBoKB
# p4Oj7Av8VwQZPLxE8UTshDFBNQsOuG3hb0NhG70t9cJEOCs9NCm6d8J3sFShFSbt
# wjYTf7J2wTksrg5kk3e3L27wKP3ACQoEkyZXsWhHiCDn1ZrqrLkUPHz/qgwjfjux
# phCeFYEYtttH08Fd5NXa9jTZKTFNYJJOPGwbsRTw/uH8GNt8lLKUs4Ocm0JqZFgI
# W9H0Kr3n9PJ/gTiIVm1oNAtxpRDD3zdxXlUN8ZXX/7kZES4bR9x2HDZe6HEAbT5q
# TxXFWdvMHMm5PGEtfZRSIw7DwwDMjE4tBlNFRU6rqfAEXrwYLHn1NpiJvqBDztsz
# Qy5SggBEYPCtATLyrnk6bdB5cngHqL5lZ325CsdPBdZR1HtuHVZGdgfhoIF2+0Nf
# DNycy4e+FMQdCGSm8PVxi9pyOqBQKL4rLS5qhk3zAqvDoQn0p4hwMQwAsgpU5L3G
# 7JbnU2Cnx773zQ==
